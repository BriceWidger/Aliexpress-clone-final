...
function setURL(newUrl) {
  return function () {
    ...
    document.getElementById("mag-overlay_camera").style.backgroundImage =
      "url('" + newUrl + "')";
...
// Camera
document
  .getElementById("preview-img-one_camera")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/olympus-camera.jpg")
  );
document
  .getElementById("preview-img-two_camera")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/olympus-camera_back.jpg")
  );
document
  .getElementById("preview-img-three_camera")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/olympus-camera_cover.jpg")
  );
document
  .getElementById("preview-img-four_camera")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/olympus-camera_shoulder.jpg")
  );
document
  .getElementById("preview-img-five_camera")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/olympus-camera_face.jpg")
  );
...
document
  .getElementById("mag-overlay_camera")
  .addEventListener("mousemove", zoomIn);

function prevImgDecoyFunctionOne_camera() {
  // prevImgDecoyFunctionOne_camera
...
function prevImgDecoyFunctionTwo_camera() {
  // prevImgDecoyFunctionTwo_camera
...
function prevImgDecoyFunctionThree_camera() {
  // prevImgDecoyFunctionThree_camera
...
function prevImgDecoyFunctionFour_camera() {
  // prevImgDecoyFunctionFour_camera
...
function prevImgDecoyFunctionFive_camera() {
  // prevImgDecoyFunctionFive_camera
