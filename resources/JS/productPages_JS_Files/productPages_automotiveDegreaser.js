...
function setURL(newUrl) {
  return function () {
    ...
    document.getElementById("mag-overlay_auto").style.backgroundImage =
      "url('" + newUrl + "')";
...
document
  .getElementById("preview-img-one_auto")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/automotiveDegreaser.jpg")
  );
document
  .getElementById("preview-img-two_auto")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/automotiveDegreaser_back.jpg")
  );
document
  .getElementById("preview-img-three_auto")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/automotiveDegreaser_description.jpg")
  );
document
  .getElementById("preview-img-four_auto")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/automotiveDegreaser_utility.jpg")
  );
document
  .getElementById("preview-img-five_auto")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/automotiveDegreaser_towel.jpg")
  );
...
document
  .getElementById("mag-overlay_auto")
  .addEventListener("mousemove", zoomIn);

function prevImgDecoyFunctionOne_auto() {
  // prevImgDecoyFunctionOne_auto
...
function prevImgDecoyFunctionTwo_auto() {
  // prevImgDecoyFunctionTwo_auto
...
function prevImgDecoyFunctionThree_auto() {
  // prevImgDecoyFunctionThree_auto
...
function prevImgDecoyFunctionFour_auto() {
  // prevImgDecoyFunctionFour_auto
...
function prevImgDecoyFunctionFive_auto() {
  // prevImgDecoyFunctionFive_auto
  ...
  if (circleMenu) {
    ...
    if (isTouchDevice()) {
      ...
      document.addEventListener("touchstart", function (e) {
        // Don't close circle menu if the touch is on the account icon
        if (e.target.closest('.person-account-icon') || e.target.closest('.acc-dropdown')) {
          return;
        }
