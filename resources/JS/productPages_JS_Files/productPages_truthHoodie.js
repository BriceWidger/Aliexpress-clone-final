...
function setURL(newUrl) {
  return function () {
    ...
    document.getElementById("mag-overlay_truth").style.backgroundImage =
      "url('" + newUrl + "')";
...
// Truth Hoodie
document
  .getElementById("preview-img-one_truth")
  .addEventListener("mouseover", setURL("/resources/images/truthhoodie.jpg"));
document
  .getElementById("preview-img-two_truth")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/truthhoodie_back.jpg")
  );
document
  .getElementById("preview-img-three_truth")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/truthhoodie_frontwhite.jpg")
  );
document
  .getElementById("preview-img-four_truth")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/truthhoodie_backwhite.jpg")
  );
document
  .getElementById("preview-img-five_truth")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/truthhoodie_zoom.png")
  );
...
document
  .getElementById("mag-overlay_truth")
  .addEventListener("mousemove", zoomIn);

function prevImgDecoyFunctionOne_truth() {
  // prevImgDecoyFunctionOne_truth
...
function prevImgDecoyFunctionTwo_truth() {
  // prevImgDecoyFunctionTwo_truth
...
function prevImgDecoyFunctionThree_truth() {
  // prevImgDecoyFunctionThree_truth
...
function prevImgDecoyFunctionFour_truth() {
  // prevImgDecoyFunctionFour_truth
...
function prevImgDecoyFunctionFive_truth() {
  // prevImgDecoyFunctionFive_truth
