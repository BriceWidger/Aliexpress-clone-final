...
function setURL(newUrl) {
  return function () {
    ...
    document.getElementById("mag-overlay_pillow").style.backgroundImage =
      "url('" + newUrl + "')";
...
// Pillow
document
  .getElementById("preview-img-one_pillow")
  .addEventListener("mouseover", setURL("/resources/images/pillow.jpg"));
document
  .getElementById("preview-img-two_pillow")
  .addEventListener("mouseover", setURL("/resources/images/pillow_one.jpg"));
document
  .getElementById("preview-img-three_pillow")
  .addEventListener("mouseover", setURL("/resources/images/pillow_side.jpg"));
document
  .getElementById("preview-img-four_pillow")
  .addEventListener("mouseover", setURL("/resources/images/pillow_push.jpg"));
document
  .getElementById("preview-img-five_pillow")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/pillow_details.jpg")
  );
...
document
  .getElementById("mag-overlay_pillow")
  .addEventListener("mousemove", zoomIn);

function prevImgDecoyFunctionOne_pillow() {
  // prevImgDecoyFunctionOne_pillow
...
function prevImgDecoyFunctionTwo_pillow() {
  // prevImgDecoyFunctionTwo_pillow
...
function prevImgDecoyFunctionThree_pillow() {
  // prevImgDecoyFunctionThree_pillow
...
function prevImgDecoyFunctionFour_pillow() {
  // prevImgDecoyFunctionFour_pillow
...
function prevImgDecoyFunctionFive_pillow() {
  // prevImgDecoyFunctionFive_pillow
