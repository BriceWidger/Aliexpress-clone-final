...
function setURL(newUrl) {
  return function () {
    ...
    document.getElementById("mag-overlay_potatoHead").style.backgroundImage =
      "url('" + newUrl + "')";
    document.getElementById("mag-overlay_potatoHead").style.display = "none";
    document.getElementById("mag-overlay-two_potatoHead").style.display =
      "none";
  };
}
...
// Potato Head
document
  .getElementById("preview-img-one_potatoHead")
  .addEventListener("mouseover", setURL("/resources/images/potatohead.jpg"));
document
  .getElementById("preview-img-two_potatoHead")
  .addEventListener("mouseover", setURL("/resources/images/potatohead_mr.jpg"));
document
  .getElementById("preview-img-three_potatoHead")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/potatohead_mrs.jpg")
  );
document
  .getElementById("preview-img-four_potatoHead")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/potatohead_mr-back.jpg")
  );
document
  .getElementById("preview-img-five_potatoHead")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/potatohead_mrs-back.jpg")
  );
...
document
  .getElementById("mag-overlay_potatoHead")
  .addEventListener("mousemove", zoomIn);

function prevImgDecoyFunctionOne_potatoHead() {
  // prevImgDecoyFunctionOne_potatoHead
  // hides img-one and displays img-one-after
  document.getElementById("preview-img-one_potatoHead").style.opacity = "0";
  document.getElementById("preview-img-one-after_potatoHead").style.opacity =
    "1";
  // hides all remaining preview-img-afters
  document.getElementById("preview-img-two-after_potatoHead").style.opacity =
    "0";
  document.getElementById("preview-img-three-after_potatoHead").style.opacity =
    "0";
  document.getElementById("preview-img-four-after_potatoHead").style.opacity =
    "0";
  document.getElementById("preview-img-five-after_potatoHead").style.opacity =
    "0";
...
function prevImgDecoyFunctionTwo_potatoHead() {
  // prevImgDecoyFunctionTwo_potatoHead
...
function prevImgDecoyFunctionThree_potatoHead() {
  // prevImgDecoyFunctionThree_potatoHead
...
function prevImgDecoyFunctionFour_potatoHead() {
  // prevImgDecoyFunctionFour_potatoHead
...
function prevImgDecoyFunctionFive_potatoHead() {
  // prevImgDecoyFunctionFive_potatoHead
