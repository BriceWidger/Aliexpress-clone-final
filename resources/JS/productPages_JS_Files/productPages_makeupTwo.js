...
function setURL(newUrl) {
  return function () {
    ...
    document.getElementById("mag-overlay_makeupTwo").style.backgroundImage =
      "url('" + newUrl + "')";
...
// Makeup Two
document
  .getElementById("preview-img-one_makeupTwo")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/makeup-img-two.jpg")
  );
document
  .getElementById("preview-img-two_makeupTwo")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/makeup-img-two_paletteTwo.jpg")
  );
document
  .getElementById("preview-img-three_makeupTwo")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/makeup-img-two_paletteOne.jpg")
  );
document
  .getElementById("preview-img-four_makeupTwo")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/makeup-img-two_fingers.jpg")
  );
document
  .getElementById("preview-img-five_makeupTwo")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/makeup-img-two_arm.jpg")
  );
...
document
  .getElementById("mag-overlay_makeupTwo")
  .addEventListener("mousemove", zoomIn);

function prevImgDecoyFunctionOne_makeupTwo() {
  // prevImgDecoyFunctionOne_makeupTwo
  // hides img-one and displays img-one-after
  document.getElementById("preview-img-one_makeupTwo").style.opacity = "0";
  document.getElementById("preview-img-one-after_makeupTwo").style.opacity =
    "1";
  // hides all remaining preview-img-afters
  document.getElementById("preview-img-two-after_makeupTwo").style.opacity =
    "0";
  document.getElementById("preview-img-three-after_makeupTwo").style.opacity =
    "0";
  document.getElementById("preview-img-four-after_makeupTwo").style.opacity =
    "0";
  document.getElementById("preview-img-five-after_makeupTwo").style.opacity =
    "0";
...
function prevImgDecoyFunctionTwo_makeupTwo() {
  // prevImgDecoyFunctionTwo_makeupTwo
...
function prevImgDecoyFunctionThree_makeupTwo() {
  // prevImgDecoyFunctionThree_makeupTwo
...
function prevImgDecoyFunctionFour_makeupTwo() {
  // prevImgDecoyFunctionFour_makeupTwo
...
function prevImgDecoyFunctionFive_makeupTwo() {
  // prevImgDecoyFunctionFive_makeupTwo
