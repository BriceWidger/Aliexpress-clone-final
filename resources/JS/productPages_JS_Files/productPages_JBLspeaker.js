...
function setURL(newUrl) {
  return function () {
    ...
    document.getElementById("mag-overlay_jbl").style.backgroundImage =
      "url('" + newUrl + "')";
...
// JBL Speaker
document
  .getElementById("preview-img-one_jbl")
  .addEventListener("mouseover", setURL("/resources/images/JBLspeaker.jpg"));
document
  .getElementById("preview-img-two_jbl")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/JBLspeaker_front.jpg")
  );
document
  .getElementById("preview-img-three_jbl")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/JBLspeaker_left.jpg")
  );
document
  .getElementById("preview-img-four_jbl")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/JBLspeaker_top.jpg")
  );
document
  .getElementById("preview-img-five_jbl")
  .addEventListener(
    "mouseover",
    setURL("/resources/images/JBLspeaker_bottom.jpg")
  );
...
document
  .getElementById("mag-overlay_jbl")
  .addEventListener("mousemove", zoomIn);

function prevImgDecoyFunctionOne_jbl() {
  // prevImgDecoyFunctionOne_jbl
...
function prevImgDecoyFunctionTwo_jbl() {
  // prevImgDecoyFunctionTwo_jbl
...
function prevImgDecoyFunctionThree_jbl() {
  // prevImgDecoyFunctionThree_jbl
...
function prevImgDecoyFunctionFour_jbl() {
  // prevImgDecoyFunctionFour_jbl
...
function prevImgDecoyFunctionFive_jbl() {
  // prevImgDecoyFunctionFive_jbl
