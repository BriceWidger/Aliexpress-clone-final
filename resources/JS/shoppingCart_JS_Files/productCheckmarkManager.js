...
*/
const selectCheckMark_zdc = document.querySelector(
  ".select-all-check-mark-icon-SC"
);

const productCheckMarks_zdc = Array.from(
  document.querySelectorAll(
    ".product-one-check-mark-icon-SC, .product-two-check-mark-icon-SC, .product-three-check-mark-icon-SC, .product-four-check-mark-icon-SC, .product-five-check-mark-icon-SC, .product-six-check-mark-icon-SC, .product-seven-check-mark-icon-SC, .product-eight-check-mark-icon-SC, .product-nine-check-mark-icon-SC, .product-ten-check-mark-icon-SC, .product-eleven-check-mark-icon-SC"
  )
);

const observers_zdc = productCheckMarks_zdc.map((productCheckMark_zdc) => {
  const observer_zdc = new MutationObserver((mutationsList) => {
    const zIndexes_zdc = productCheckMarks_zdc.map((productCheckMark_zdc) =>
      parseInt(productCheckMark_zdc.style.zIndex)
    );
    const anyZIndexIsMinusOne_zdc = zIndexes_zdc.some(
      (zIndex_zdc) => zIndex_zdc === -1
    );
...
const selectAllCheckMarkIconSC = document.querySelector(
  ".select-all-check-mark-icon-SC"
);
const productCheckMarkIconsSC = document.querySelectorAll(
  ".product-one-check-mark-icon-SC, .product-two-check-mark-icon-SC, .product-three-check-mark-icon-SC, .product-four-check-mark-icon-SC, .product-five-check-mark-icon-SC, .product-six-check-mark-icon-SC, .product-seven-check-mark-icon-SC, .product-eight-check-mark-icon-SC, .product-nine-check-mark-icon-SC, .product-ten-check-mark-icon-SC, .product-eleven-check-mark-icon-SC"
);
...
selectAllCheckMarkIconSC.addEventListener("click", () => {
  ...
  cpCheckoutButton.style.transition =
...
const selectAllEmptyCircleCheckMarkIconSC = document.querySelector(
  ".select-all-empty-circle-check-mark-icon-sc"
);
...
selectAllEmptyCircleCheckMarkIconSC.addEventListener("click", function () {
  ...
  document.querySelector(".cp-checkout-button").style.border =
    "0px solid rgb(0, 0, 0)";
...
function toggleProductCheckMarkIconsZIndex() {
  const selectAllCheckMarkIcon = document.querySelector(
    ".select-all-check-mark-icon-SC"
  );
  const productCheckMarkIconsArray = document.querySelectorAll(
    ".product-one-check-mark-icon-SC, .product-two-check-mark-icon-SC, .product-three-check-mark-icon-SC, .product-four-check-mark-icon-SC, .product-five-check-mark-icon-SC, .product-six-check-mark-icon-SC, .product-seven-check-mark-icon-SC, .product-eight-check-mark-icon-SC, .product-nine-check-mark-icon-SC, .product-ten-check-mark-icon-SC, .product-eleven-check-mark-icon-SC"
  );
  const getCheckMarkIconZIndex = (icon) =>
    parseInt(window.getComputedStyle(icon).zIndex) || 1;

  productCheckMarkIconsArray.forEach(
    (icon) =>
      (icon.style.zIndex = getCheckMarkIconZIndex(selectAllCheckMarkIcon))
  );
}

document
  .querySelector(".select-all-check-mark-icon-SC")
  .addEventListener("click", toggleProductCheckMarkIconsZIndex);
...
function updateCheckoutCountValue() {
  ...
  const cartProductDetailsWraps = document.querySelectorAll(
  ...
  const visibleCartProductDetailsWraps = Array.from(
    cartProductDetailsWraps
  ...
  productCheckMarkIconsArray.forEach((icon, index) => {
    ...
    if (
      correspondingWrap &&
      (getCheckMarkIconZIndex(icon) === 1 ||
        getCheckMarkIconZIndex(icon) === "" ||
        getCheckMarkIconZIndex(icon) === "auto")
    ) {
      count++;
    }
  });
...
function hideSelectAllTextIfAllIndvidualCheckmarksHaveNegativeZIndex() {
  var cartProductDetailsWraps = document.querySelectorAll(
    ".cart-product-details-wrap-one, .cart-product-details-wrap-two, .cart-product-details-wrap-three, .cart-product-details-wrap-four, .cart-product-details-wrap-five, .cart-product-details-wrap-six, .cart-product-details-wrap-seven, .cart-product-details-wrap-eight, .cart-product-details-wrap-nine, .cart-product-details-wrap-ten, .cart-product-details-wrap-eleven"
  );
  ...
  cartProductDetailsWraps.forEach(function (cartProductDetailsWrap) {
    if (cartProductDetailsWrap.offsetParent !== null) {
      var checkMarkIcon = cartProductDetailsWrap.querySelector(
        ".product-one-check-mark-icon-SC, .product-two-check-mark-icon-SC, .product-three-check-mark-icon-SC, .product-four-check-mark-icon-SC, .product-five-check-mark-icon-SC, .product-six-check-mark-icon-SC, .product-seven-check-mark-icon-SC, .product-eight-check-mark-icon-SC, .product-nine-check-mark-icon-SC, .product-ten-check-mark-icon-SC, .product-eleven-check-mark-icon-SC"
      );
  ...
  if (allHaveZIndexMinusOne) {
    document.querySelector(".cart-header-delete-items-text").style.display =
      "none";
  } else {
    document.querySelector(".cart-header-delete-items-text").style.display =
      "block";
...
const productOneCheckMarkIcon = document.querySelectorAll(
  ".product-one-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countOne = parseFloat(
    document.querySelector("#productCountOne").textContent
  );

  if (
    target.classList.contains("product-one-empty-circle-check-mark-icon-sc")
  ) {
...
const productTwoCheckMarkIcon = document.querySelectorAll(
  ".product-two-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countTwo = parseFloat(
    document.querySelector("#productCountTwo").textContent
  );

  if (
    target.classList.contains("product-two-empty-circle-check-mark-icon-sc")
  ) {
...
const productThreeCheckMarkIcon = document.querySelectorAll(
  ".product-three-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countThree = parseFloat(
    document.querySelector("#productCountThree").textContent
  );

  if (
    target.classList.contains("product-three-empty-circle-check-mark-icon-sc")
  ) {
...
const productFourCheckMarkIcon = document.querySelectorAll(
  ".product-four-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countFour = parseFloat(
    document.querySelector("#productCountFour").textContent
  );

  if (
    target.classList.contains("product-four-empty-circle-check-mark-icon-sc")
  ) {
...
const productFiveCheckMarkIcon = document.querySelectorAll(
  ".product-five-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countFive = parseFloat(
    document.querySelector("#productCountFive").textContent
  );

  if (
    target.classList.contains("product-five-empty-circle-check-mark-icon-sc")
  ) {
...
const productSixCheckMarkIcon = document.querySelectorAll(
  ".product-six-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countSix = parseFloat(
    document.querySelector("#productCountSix").textContent
  );

  if (
    target.classList.contains("product-six-empty-circle-check-mark-icon-sc")
  ) {
...
const productSevenCheckMarkIcon = document.querySelectorAll(
  ".product-seven-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countSeven = parseFloat(
    document.querySelector("#productCountSeven").textContent
  );

  if (
    target.classList.contains("product-seven-empty-circle-check-mark-icon-sc")
  ) {
...
const productEightCheckMarkIcon = document.querySelectorAll(
  ".product-eight-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countEight = parseFloat(
    document.querySelector("#productCountEight").textContent
  );

  if (
    target.classList.contains("product-eight-empty-circle-check-mark-icon-sc")
  ) {
...
const productNineCheckMarkIcon = document.querySelectorAll(
  ".product-nine-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countNine = parseFloat(
    document.querySelector("#productCountNine").textContent
  );

  if (
    target.classList.contains("product-nine-empty-circle-check-mark-icon-sc")
  ) {
...
const productTenCheckMarkIcon = document.querySelectorAll(
  ".product-ten-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countTen = parseFloat(
    document.querySelector("#productCountTen").textContent
  );

  if (
    target.classList.contains("product-ten-empty-circle-check-mark-icon-sc")
  ) {
...
const productElevenCheckMarkIcon = document.querySelectorAll(
  ".product-eleven-check-mark-icon-SC"
);

document.addEventListener("click", function (event) {
  const target = event.target;
  const countEleven = parseFloat(
    document.querySelector("#productCountEleven").textContent
  );

  if (
    target.classList.contains("product-eleven-empty-circle-check-mark-icon-sc")
  ) {
...
function createDisabledElements(
  ...
  observer.observe(checkMarkIcon, {
    attributes: true,
  ...
  Object.keys(values).forEach((key) => {
    ...
    if (localStorage.getItem(`${priceKey}_original`)) {
      localStorage.setItem(
        priceKey,
        localStorage.getItem(`${priceKey}_original`)
      );
      document.querySelector(`.${product}_${key}`).textContent =
        localStorage.getItem(priceKey);
...
document.addEventListener(
  "DOMContentLoaded",
  restoreOriginalValues_productPrices
);
...
document
  .querySelector(".product-one-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceOne"));
document
  .querySelector(".product-one-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceOne", productOneValues)
  );

document
  .querySelector(".product-two-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceTwo"));
document
  .querySelector(".product-two-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceTwo", productTwoValues)
  );

document
  .querySelector(".product-three-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceThree"));
document
  .querySelector(".product-three-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceThree", productThreeValues)
  );

document
  .querySelector(".product-four-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceFour"));
document
  .querySelector(".product-four-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceFour", productFourValues)
  );

document
  .querySelector(".product-five-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceFive"));
document
  .querySelector(".product-five-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceFive", productFiveValues)
  );

document
  .querySelector(".product-six-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceSix"));
document
  .querySelector(".product-six-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceSix", productSixValues)
  );

document
  .querySelector(".product-seven-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceSeven"));
document
  .querySelector(".product-seven-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceSeven", productSevenValues)
  );

document
  .querySelector(".product-eight-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceEight"));
document
  .querySelector(".product-eight-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceEight", productEightValues)
  );

document
  .querySelector(".product-nine-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceNine"));
document
  .querySelector(".product-nine-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceNine", productNineValues)
  );

document
  .querySelector(".product-ten-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceTen"));
document
  .querySelector(".product-ten-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceTen", productTenValues)
  );

document
  .querySelector(".product-eleven-check-mark-icon-SC")
  .addEventListener("click", () => toggleCheckMarkPrice("productPriceEleven"));
document
  .querySelector(".product-eleven-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () =>
    addPriceBack("productPriceEleven", productElevenValues)
  );
...
document
  .querySelector(".select-all-empty-circle-check-mark-icon-sc")
  .addEventListener("click", () => {
